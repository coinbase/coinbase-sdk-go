...
func main() {
	...
	stakeableBalance, err := client.GetStakeableBalance(ctx, assetID, address)
	if err != nil {
	...
	stakingOperation, err := client.BuildStakeOperation(ctx, big.NewFloat(1000000000.00), coinbase.Eth, address)
	if err != nil {
