...
func main() {
	...
	unstakeableBalance, err := client.GetUnstakeableBalance(ctx, assetID, address)
	if err != nil {
	...
	stakingOperation, err := client.BuildUnstakeOperation(ctx, big.NewFloat(0.0001), coinbase.Eth, address)
	if err != nil {
