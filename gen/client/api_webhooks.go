...
type WebhooksAPI interface {
	...
	/*
	CreateWalletWebhook Create a new webhook scoped to a wallet

	Create a new webhook scoped to a wallet

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param walletId The ID of the wallet to create the webhook for.
	@return ApiCreateWalletWebhookRequest
	*/
	CreateWalletWebhook(ctx context.Context, walletId string) ApiCreateWalletWebhookRequest

	// CreateWalletWebhookExecute executes the request
	//  @return Webhook
	CreateWalletWebhookExecute(r ApiCreateWalletWebhookRequest) (*Webhook, *http.Response, error)
...
func (r ApiCreateWalletWebhookRequest) Execute() (*Webhook, *http.Response, error) {
...
Create a new webhook scoped to a wallet
 ...
 @return ApiCreateWalletWebhookRequest
*/
func (a *WebhooksAPIService) CreateWalletWebhook(ctx context.Context, walletId string) ApiCreateWalletWebhookRequest {
	return ApiCreateWalletWebhookRequest{
		ApiService: a,
		ctx: ctx,
		walletId: walletId,
...
//  @return Webhook
func (a *WebhooksAPIService) CreateWalletWebhookExecute(r ApiCreateWalletWebhookRequest) (*Webhook, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "WebhooksAPIService.CreateWalletWebhook")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/wallets/{wallet_id}/webhooks"
