...
*/
func (a *StakeAPIService) BroadcastStakingOperation(ctx context.Context, walletId string, addressId string, stakingOperationId string) ApiBroadcastStakingOperationRequest {
	return ApiBroadcastStakingOperationRequest{
		ApiService: a,
		ctx: ctx,
		walletId: walletId,
...
func (a *StakeAPIService) BroadcastStakingOperationExecute(r ApiBroadcastStakingOperationRequest) (*StakingOperation, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "StakeAPIService.BroadcastStakingOperation")
	if err != nil {
...
*/
func (a *StakeAPIService) CreateStakingOperation(ctx context.Context, walletId string, addressId string) ApiCreateStakingOperationRequest {
	return ApiCreateStakingOperationRequest{
		ApiService: a,
		ctx: ctx,
		walletId: walletId,
...
// Execute executes the request
//  @return StakingOperation
func (a *StakeAPIService) CreateStakingOperationExecute(r ApiCreateStakingOperationRequest) (*StakingOperation, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "StakeAPIService.CreateStakingOperation")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (a *StakeAPIService) GetStakingOperation(ctx context.Context, walletId string, addressId string, stakingOperationId string) ApiGetStakingOperationRequest {
	return ApiGetStakingOperationRequest{
		ApiService: a,
		ctx: ctx,
		walletId: walletId,
...
// Execute executes the request
//  @return StakingOperation
func (a *StakeAPIService) GetStakingOperationExecute(r ApiGetStakingOperationRequest) (*StakingOperation, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "StakeAPIService.GetStakingOperation")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
