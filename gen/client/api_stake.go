...
Get a validator belonging to the user for a given network, asset and id.
 ...
 @return ApiGetValidatorRequest
*/
func (a *StakeAPIService) GetValidator(ctx context.Context, networkId string, assetId string, validatorId string) ApiGetValidatorRequest {
	return ApiGetValidatorRequest{
		ApiService: a,
		ctx: ctx,
		networkId: networkId,
...
// Execute executes the request
//  @return Validator
func (a *StakeAPIService) GetValidatorExecute(r ApiGetValidatorRequest) (*Validator, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "StakeAPIService.GetValidator")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
List validators belonging to the user for a given network and asset.
 ...
 @return ApiListValidatorsRequest
*/
func (a *StakeAPIService) ListValidators(ctx context.Context, networkId string, assetId string) ApiListValidatorsRequest {
	return ApiListValidatorsRequest{
		ApiService: a,
		ctx: ctx,
		networkId: networkId,
...
// Execute executes the request
//  @return ValidatorList
func (a *StakeAPIService) ListValidatorsExecute(r ApiListValidatorsRequest) (*ValidatorList, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "StakeAPIService.ListValidators")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
