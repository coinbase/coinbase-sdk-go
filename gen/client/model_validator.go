...
func NewValidator(validatorId string, networkId string, assetId string, status string) *Validator {
	this := Validator{}
...
func (o *Validator) GetStatus() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *Validator) GetStatusOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *Validator) SetStatus(v string) {
	o.Status = v
}
